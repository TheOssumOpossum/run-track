...
import { UserIcon, LeaderboardIcon, TrophyIcon, BoltIcon, ChartIcon, RunningShoeIcon } from '../components/icons';
...
export default function ProfileScreen({ user, handleSignOut, loading, appId }) {
    ...
    return (
        <div id="profile-screen" className="w-full max-w-3xl mx-auto">
            ...
            {/* Tabs */}
            <div id="profile-tabs" className="mt-6 py-6 px-4">
                <div id="profile-tabs-nav" className="flex space-x-2 border-b border-gray-100 pb-2">
                ...
                <div id="profile-tabs-content" className="mt-4">
